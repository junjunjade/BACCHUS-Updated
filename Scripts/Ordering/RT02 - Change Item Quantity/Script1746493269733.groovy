...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 2'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 2'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.Button - ORDER'), 
    0)
...
Mobile.setText(findTestObject('Object Repository/Regular Transactions/android.widget.EditText - Number of Pax'), '3', 
    0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - French Vanilla Crepe Cake Whole'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - French Vanilla Crepe Cake Whole'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - 4'), 0)
