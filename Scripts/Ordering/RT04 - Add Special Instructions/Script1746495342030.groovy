...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 4'), 0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 4'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.Button - LA POMME'), 
    0)
...
Mobile.setText(findTestObject('Object Repository/Regular Transactions/android.widget.EditText - Special Instruction'), 'less sugar', 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 4'), 
    0)
