...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 5'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 5'), 0)
...
Mobile.setText(findTestObject('Object Repository/Regular Transactions/android.widget.EditText - Number of Pax'), '4', 0)
...
Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - BASIC CREPE'), 0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - SPECIAL CAKES'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.Button - TIRAMISU'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - TIRAMISU'), 0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - CHOCOLATE MOUSSE'), 0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - ADD ORDER SLIP'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.EditText - Order Slip'), 0)

Mobile.setText(findTestObject('Object Repository/Regular Transactions/android.widget.EditText - Order Slip'), 'echo', 0)
