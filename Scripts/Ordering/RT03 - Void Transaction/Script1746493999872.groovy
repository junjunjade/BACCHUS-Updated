...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 3'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 3'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.Button - BASIC CREPE'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - BASIC CREPE'), 0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - FRENCH TOAST'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.Button - MANGO AND CREAM FRENCH TOAST'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - MANGO AND CREAM FRENCH TOAST'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - NEXT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.Button - VOID TRANSACTION'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.Button - VOID TRANSACTION'), 0)
