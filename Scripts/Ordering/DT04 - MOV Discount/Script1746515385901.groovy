...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - COFFEE'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - COFFEE'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - CAPPUCCINO'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - MEDAL OF VALOR'), 0)
