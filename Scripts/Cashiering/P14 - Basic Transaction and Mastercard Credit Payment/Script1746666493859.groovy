...
Mobile.waitForElementPresent(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 14'), 
    0)

Mobile.tap(findTestObject('Object Repository/Regular Transactions/android.widget.TextView - Table 14'), 0)
...
int startX = (deviceWidth * 0.9).toInteger()   // right side
int endX = (deviceWidth * 0.3).toInteger()     // left side
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - MASTER CARD CREDIT'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - MASTER CARD CREDIT'), 0)
