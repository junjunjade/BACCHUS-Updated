...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 11'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - TWG'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - TWG'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - SILVERMOON SINGLE POT'), 
    0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - SILVERMOON SINGLE POT'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - PARIS SINGAPORE SINGLE POT'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - DISCOUNT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - 40 OTHER DISCOUNT'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - NFC'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - NFC'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), '414141232', 0)
