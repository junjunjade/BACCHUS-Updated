...
Mobile.scrollToText('Table 12', FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 12'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 12'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - CHOCOLATE DRINKS'), 0)
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - CHOCOLATE DRINKS'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - SAN GINES'), 0)
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - SAN GINES'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - PARIS MANILA'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - FROZEN HOT CHOCOLATE'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - DISCOUNT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - 50 OTHER DISCOUNT'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - FOOD PANDA'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - FOOD PANDA'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), '1111111111111', 0)
