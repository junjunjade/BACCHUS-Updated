...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 9'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 9'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - SALTED BUTTER CARAMEL CHIFFO'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - SALTED BUTTER CARAMEL CHIFFON CAKE SLICE'), 
    0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - DISCOUNT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - 20 OTHER DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - 20 OTHER DISCOUNT'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - PAYPAL'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - PAYPAL'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), '36912151821218', 0)
