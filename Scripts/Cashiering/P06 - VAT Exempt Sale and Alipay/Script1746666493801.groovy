...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.TextView - Table 6'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 6'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - ORDER'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - ORDER'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - Number of Pax'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - GB-CHOCOLATE MOUSSE'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - GB-CHOCOLATE MOUSSE'), 0)
...
Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - Name'), 'Wendel', 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 6'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - NEXT'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - NEXT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - ALIPAY'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - ALIPAY'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), '23436433', 0)
