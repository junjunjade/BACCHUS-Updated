...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - SPECIAL CAKES'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - SPECIAL CAKES'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - TIRAMISU'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - TIRAMISU'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - SALTED BUTTER CARAMEL CHIFFON CAKE SLICE'), 
    0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - GB-TRIPLE CHOCOLATE CAKE SLICE'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - ATHLETE DISCOUNT'), 0)
...
Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - Name'), 'Kobe Bryant', 0)

Mobile.setText(findTestObject('Object Repository/Discounts/android.widget.EditText - ID No'), '2408', 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - MASTER CARD DEBIT'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - MASTER CARD DEBIT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), '1231230909853', 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.EditText - EXP DATE TAP'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - 5 DATE'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - 5 DATE'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - 2026 DATE'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - OK DATE'), 0)
