...
Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - STEWED APPLES'), 0)

Mobile.tap(findTestObject('Object Repository/Discounts/android.widget.Button - DISCOUNT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.Button - 10 OTHER DISCOUNT'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Discounts/android.widget.TextView - Table 7'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - VISA DEBIT'), 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.Button - VISA DEBIT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Cashiering/android.widget.EditText - REF NO'), '8080808080121', 0)

Mobile.tap(findTestObject('Object Repository/Cashiering/android.widget.EditText - EXP DATE TAP'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Cashiering/android.widget.Button - 2026 DATE'), 0)
